...
export const LotteryGrid: React.FC<LotteryGridProps> = ({ drawnNumbers }) => {
  ...
  return (
    <Card className="bg-white/95 backdrop-blur-sm shadow-2xl border-2 border-blue-400/50">
      <CardHeader className="text-center bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-t-lg">
        <CardTitle className="text-xl flex items-center justify-center gap-2">
          <Grid className="w-5 h-5" />
          Tabellone dei Numeri (1-90)
        </CardTitle>
      </CardHeader>
            ...
            return (
              <div
                ...
                className={`
                  ...
                  ${isDrawn 
                    ? 'bg-gradient-to-br from-yellow-500 to-yellow-600 text-white border-yellow-400 shadow-lg scale-110 animate-pulse' 
