  ...
  return (
    <Card className="bg-white/95 backdrop-blur-sm shadow-2xl border-2 border-blue-400/50 h-full">
      ...
      <CardContent className="p-6">
        <div className="grid grid-cols-12 gap-3 sm:gap-4 md:gap-5 text-3xl">
          {numbers.map((number) => {
            ...
            return (
              <div
                key={number}
                className={`
                  w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-xl flex items-center justify-center font-extrabold text-2xl md:text-3xl transition-all duration-300 border-2
                  ${isDrawn 
